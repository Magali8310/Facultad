...
def main():
    ...
    with open(input_path, "r") as input_file, open(output_path, "w") as output_file:
        ...
        while True:
            ...
            distances = get_distance_matrix(cordinates_nodes, cordinates_packages)
            model, deliver = optimize_asignation_cost(n, m, S, capacities, costs, coverage, distances)
